...
syn match newTodo        /^\[\s\+\].*$/ contains=celComment,celTodo
syn match inProgressTodo /^\[\.\+\].*$/ contains=celComment,celTodo
syn match completedTodo  /^\[X\+\].*$/ contains=celComment,celTodo
